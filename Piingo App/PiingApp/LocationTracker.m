...
-(void)locationManager:(CLLocationManager *)manager didUpdateLocations:(NSArray *)locations{
    ...
    appDel.latitude = [NSString stringWithFormat:@"%lf", ((CLLocation*)[locations objectAtIndex:0]).coordinate.latitude];
    appDel.longitude = [NSString stringWithFormat:@"%lf", ((CLLocation*)[locations objectAtIndex:0]).coordinate.longitude];
...
//    [appDel.piingo_GoogleMap addPiingoMarkder:dictPiingo];
    ...
    if (!appDel.isFirstTimeConnected)
    {
        appDel.isFirstTimeConnected = YES;
        
        [appDel connectPiingobWhenLogin];
    }
...
-(void)locationManager:(CLLocationManager *)manager didUpdateHeading:(CLHeading *)newHeading {
    ...
    appDel.vehicle_direction = newHeading.trueHeading;
