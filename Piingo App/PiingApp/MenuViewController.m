...
//    titles = @[@"My Order", @"My Account", @"Panic", @"Transfer", @"Reconcile", @"Price list", @"Settings", @"Call Support", @"SMS Support", @"Log Out"];
    ...
    titles = @[@"My Order", @"Create Order", @"My Account", @"Receive Bags", @"Panic", @"Transfer", @"Reconcile Cash", @"Price list", @"Call Support", @"SMS Support", @"Log Out"];
//    titleImages = @[@"ordersIcon", @"adcohIcon", @"AccountIcon", @"emergency", @"transferIcon", @"reconcile", @"PriceTag", @"callIcon", @"SMSIcon", @"LogoutIcon"];
    titleImages = @[@"my_order_icon", @"create_order", @"my_account", @"my_account", @"panic", @"transfer", @"recoicer", @"pricelist", @"call_icon", @"sms", @"logout"];
