...
@implementation WashAndFoldBagTableViewCell
...
//        if ([[[[[[[[json objectForKey:@"bag"] objectAtIndex:0] objectForKey:@"WF"] objectForKey:@"items"] objectAtIndex:0] objectForKey:@"aer"] capitalizedString] isEqualToString:@"YES"])
//        {
...
//        }
        ...
        NSDictionary *dict = [[json objectForKey:@"Bag"] objectAtIndex:0];
        
        tagTextFeild.text = [NSString stringWithFormat:@"#%@", [dict objectForKey:@"BagNo"]];
        
        {
            ...
            UILabel *bagPriceValue = [[UILabel alloc] initWithFrame:CGRectMake(screen_width-120-25, CGRectGetMaxY(itemTypeLabel.frame)+10, 100, 20.0)];
            bagPriceValue.textAlignment = NSTextAlignmentRight;
            ...
            bagPriceValue.text = [NSString stringWithFormat:@"$%.2f",[[dict objectForKey:@"Total"] floatValue]];
            ...
            if ([[json objectForKey:@"serviceTypesId"] isEqualToString:@"WF"])
            {
                itemTypeLabel.text = @"Load Wash";
                infoLabel.text = [NSString stringWithFormat:@"Number of kgs - %.2f", [[dict objectForKey:@"weight"] floatValue]];
            }
            else if ([[json objectForKey:@"serviceTypesId"] isEqualToString:@"CA"])
            {
                itemTypeLabel.text = @"Carpet Cleaning";
                infoLabel.text = [NSString stringWithFormat:@"Number of sqfts - %.2f", [[dict objectForKey:@"weight"] floatValue]];
            }
